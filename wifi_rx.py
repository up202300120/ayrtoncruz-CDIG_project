...
class wifi_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._samp_rate_labels = ['5 MHz', '10MHz', '20MHz']
        ...
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, 20e6, True, 0 if "time" == "auto" else max( int(float(0.1) * 20e6) if "time" == "time" else int(0.1), 1) )
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/ayrto/Wifi_Project_Baseband_recordings (1)/Wifi_Project_Baseband_recordings/Sample3_20MHz_Channel100.bin', False, 0, 0)
        ...
        # Create the options list
        self._Io_offset_options = [0, 6000000.0, 11000000.0]
        # Create the labels list
        self._Io_offset_labels = ['0', '6000000.0', '11000000.0']
        # Create the combo box
        self._Io_offset_tool_bar = Qt.QToolBar(self)
        self._Io_offset_tool_bar.addWidget(Qt.QLabel("'Io_offset'" + ": "))
        self._Io_offset_combo_box = Qt.QComboBox()
        self._Io_offset_tool_bar.addWidget(self._Io_offset_combo_box)
        for _label in self._Io_offset_labels: self._Io_offset_combo_box.addItem(_label)
        self._Io_offset_callback = lambda i: Qt.QMetaObject.invokeMethod(self._Io_offset_combo_box, "setCurrentIndex", Qt.Q_ARG("int", self._Io_offset_options.index(i)))
        self._Io_offset_callback(self.Io_offset)
        self._Io_offset_combo_box.currentIndexChanged.connect(
            lambda i: self.set_Io_offset(self._Io_offset_options[i]))
        # Create the radio buttons
        self.top_layout.addWidget(self._Io_offset_tool_bar)
    ...
    def set_sync_length(self, sync_length):
        ...
        self.blocks_delay_1.set_dly(int(self.sync_length))
    ...
    def get_Io_offset(self):
        return self.Io_offset

    def set_Io_offset(self, Io_offset):
